...
* a variável "X" e "Y" ( Que está na memória "STACK" ) ficará alocado somente um indereço de memória,
* apontando para o "OBJETO" que foi criado no "HEAP"( Aonde ficam os elementos dinâmicos ).
* */

/* Beneficios de calcular a aréa de um triângulo por meio de um "MÉTODO" dentro da "CLASSE"
 * 
 ...
 * 
 * 2 - Delegação de responsabilidades: quem deve ser responsável por saber como calcular
 * a área de um triângulo é o próprio triângulo. a lógica do cálculo da área,
 * não deve estar em outro lugar. 
 * */
