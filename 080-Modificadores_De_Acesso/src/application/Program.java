...
public class Program {
	...
	public static void main(String[] args) {
		 ...
		 * (ao menos que ele resida em um módulo diferente que não exporte o pacote aonde ele está).
		 */
		
		/*System.out.println(product.name); Não consigo acessar a classe por ser privete
		 * mesmo retirando o privete nesse caso não consigo acessar por pertencer uma classe
		 * dentro de outro pacote*/
